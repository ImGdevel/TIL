...
Spring Security는 엔터프라이즈 애플리케이션의 인증과 인가를 담당하는 대표적인 프레임워크입니다. 처음 접하면 수많은 컴포넌트와 인터페이스 때문에 구조를 파악하기 어렵습니다.

특히 "왜 이렇게 많은 클래스가 필요한가?"라는 질문이 자연스럽게 생깁니다. 각 컴포넌트의 역할과 협력 구조를 기준으로 보면, 이 설계가 유연성과 확장성을 확보하기 위한 것임을 알 수 있습니다.
