...
> Redis Streams 기초와 PEL 개념은 [Redis Stream으로 이벤트 로그 다루기](<../Tech Blog/Redis Stream으로 이벤트 로그 다루기.md>)를 참고한다.
...
> DLQ, retry, dead letter 개념은 [메시징 패턴: MQ, Pub/Sub, Stream, Kafka](../../../TIL.wiki/messaging-patterns-pubsub-stream-kafka.md)를 참고한다.
