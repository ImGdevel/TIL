...
> 태그: `#db` `#mysql` `#postgresql` `#rdbms`<br>
> 작성일: 2026-06-23<br>
> 최종 수정일: 2026-06-23

## 정의

MySQL과 PostgreSQL은 둘 다 MVCC를 지원하는 오픈소스 RDBMS이지만, MVCC 구현 방식·타입 시스템·쿼리 플래너·복제 생태계·운영 복잡도에서 근본적인 차이가 있어 워크로드 특성에 따라 선택이 갈린다.
