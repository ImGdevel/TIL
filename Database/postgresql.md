...
> 태그: `#db` `#postgresql` `#rdbms`<br>
> 작성일: 2026-06-23<br>
> 최종 수정일: 2026-06-23

## 정의

PostgreSQL은 강력한 쿼리 플래너, 풍부한 확장 타입 시스템(배열, JSONB, 범위 타입 등), 다양한 인덱스 종류, Extension 기반 확장성을 갖춘 오픈소스 객체-관계형 데이터베이스로 복잡한 쿼리와 특수 도메인(지리, 시계열 등)에 강점이 있다.
