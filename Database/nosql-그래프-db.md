...
> 태그: `#db` `#nosql` `#graph-db` `#neo4j`<br>
> 작성일: 2026-06-23<br>
> 최종 수정일: 2026-06-23

## 정의

Graph DB는 데이터를 노드(Node)와 엣지(Edge)로 표현하여 관계 자체를 1차 데이터로 다루는 NoSQL 유형으로, Index-Free Adjacency 구조 덕분에 관계 탐색 깊이가 깊어져도 성능이 거의 일정하다.
