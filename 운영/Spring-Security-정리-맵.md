...
| `Spring Security CORS` | `Spring Security/CORS.md` | `Spring Security/CORS-원인-추적.md` | 병합 후 승격 | 개념 문서 + 문제 추적 사례 문서 조합 |
...
- `Spring Security/CORS-원인-추적.md`: 필터 체인 관점에서 원인 추적한 사례 문서
